document.addEventListener('DOMContentLoaded', function() {
  ...
  let output = document.querySelector('.output'); // Make sure this line is here
  ...
  document.getElementById('copyButton').addEventListener('click', function(event) {
      ...
      const outputContent = output.innerText.trim(); // Get trimmed output text
      if (outputContent) {
          ...
          alert('Nothing to copy! Please generate some output first.'); // Alert if nothing to copy
      }
  });
